...
import { AllOrgIcon, DeactivateUserIcon, InactiveUserIcon, UserIcon, NetworkrIcon } from '@/components/icons/icon';
...
import { appointmentsData, colors, employees, organizations, organizationStats, patientData } from '@/utils/dashboard';
    ...
    <div className="min-h-screen w-full  mb-10">
      ...
      <main className="container mx-auto  py-6 px-[30px]">
        <div className="flex flex-col items-center md:items-start gap-1 py-2">
          ...
          <h1 className="text-[18px] md:text-[20px] font-medium text-[#595959]">Welcome,</h1>
          <h2 className="text-[20px] md:text-[24px] font-bold text-[#003465]">Daniel James!</h2>
          </div>
