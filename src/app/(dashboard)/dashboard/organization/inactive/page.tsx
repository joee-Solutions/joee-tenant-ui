...
function PageContent() {
  ...
  // Map dashboard data to StatCard format - only All and Inactive
  const statsCards = [
    {
    ...
    },
    {
      ...
      growth: dashboardData?.totalTenants && dashboardData?.inactiveTenants !== undefined
        ? parseFloat(
    ...
    <section className="px-[30px] mb-10">
      {isAddOrg === "add" ? (
        ...
        <>
          ...
          {/* Stat Cards - Only All and Inactive (2 cards, each taking 2 columns out of 4) */}
          {dashboardLoading ? (
