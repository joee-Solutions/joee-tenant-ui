...
import { Plus, Building2, UserRoundX } from "lucide-react";
...
function PageContent() {
  ...
  const [status, setStatus] = useState("Deactivated"); // Default to Deactivated for this page
  ...
  // Map dashboard data to StatCard format - only All and Deactivated
  const statsCards = [
    {
      ...
      {isAddOrg === "add" ? (
        ...
        <>
          <header className="flex items-center gap-6 justify-between flex-wrap mb-[50px]">
            <h2 className="text-2xl text-black font-normal">Deactivated Organizations</h2>
          ...
          {/* Stat Cards - Only All and Deactivated (2 cards, each taking 2 columns out of 4) */}
          {dashboardLoading ? (
              ...
              {tenantsLoading ? (
                ...
                <TableRow>
                  <TableCell colSpan={5} className="text-center py-8 text-gray-500">
                    No deactivated organizations found
                  </TableCell>
                </TableRow>
              )}
            </DataTable>
